...
\cventry
{Officer} % Job title
{Stanford DanceSport — Ballroom Dancing Club} % Organization
...
{Dec. 2023 - Present} % Date(s)
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
    ...
    % \item{Lead group team practice for beginner (bronze) dancers}
    % \item{Maintain the a publicly-accessible notion with various resources}
    % \item{Designed custom jackets for the team}
  \end{cvitems}
}

\cventry
{Commodore of Coffee Ride, Team Room Manager} % Job title
{Stanford Cycling Club} % Organization
{Stanford, CA} % Location
